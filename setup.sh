...
echo "   /plugin marketplace add hzx-coder0/claude-codex-notifications"
echo ""
echo "2. Install plugin:"
echo "   /plugin install claude-codex-notifications@claude-codex-notifications"
echo ""
echo "3. Restart Claude Code for hooks to take effect"
echo ""
echo "4. Download the binary for your platform:"
echo "   /claude-codex-notifications:init"
echo ""
echo "5. Configure notification sounds (optional):"
echo "   /claude-codex-notifications:settings"
echo ""
...
echo "      run /claude-codex-notifications:init for the first time."
echo ""
